    ...
    return(
        <div className=''>
            ...
            <div className=" lg:hidden block">
                <div className=" -mt-5 font-bold text-2xl bg-white text-[#474747] w-full flex justify-center gap-2 shadow-md pb-5 border-b-2">
                    <h1>CONTACT MENU </h1>
                </div>
            </div>
            <div className=" bg-gray-100 py-20 px-10 w-full flex max-lg:flex-col-reverse justify-center items-center gap-20">
                ...
                <Image className=" w-1/2 object-contain" unoptimized width={100} height={100} src={'https://dlqxt4mfnxo6k.cloudfront.net/destinationhomes.com/aHR0cHM6Ly9zMy5hbWF6b25hd3MuY29tL2J1aWxkZXJjbG91ZC83M2Q3NjdiOWM1MDczZjhmMjI2N2ExYjBhNjFlYWFjMS5qcGVn/webp/1200/1200'} alt="cont"/>
            </div>
            ...
            <div className=" overflow-hidden py-32 px-20 gap-3 flex justify-center items-center">
                <div className=" w-[33.3%]  overflow-hidden relative">
